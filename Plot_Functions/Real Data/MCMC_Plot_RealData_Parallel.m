function MCMC_Plot_RealData_Parallel(res,N_burn,N_trim,int_recon,int_cred)
...
model_param_count = res.setup.DETECTOR_X + res.setup.TILT;
...
if nargin>2
    ...
    figure
    h4 = tight_subplot(1,3,[0.1,0.02],[0.05,0.05],[0.05,0.01]);
    axes(h4(1))
