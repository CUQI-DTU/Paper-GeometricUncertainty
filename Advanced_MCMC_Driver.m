%Driver script for UQ sampling method using the sparse beads data set
...
setup.N_samples = 6000;                 %Number of total Gibbs samples
setup.saveRecons = 0;
...
setup.cor_sigma_proposal = 0.00002;
